        ...
        <>
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="" className="flex items-center">
                    <Image src={"/DropMeterLogo.png"} alt={"DropMeterLogo"} width={120} height={50}></Image>
                </a>
                <div className="flex md:order-2 gap-4">
                    ...
                    <button type="button"
                            className="text-white flex items-center gap-1 bg-gray-500 bg-opacity-50 hover:bg-gray-600 hover:bg-opacity-50 rounded text-sm px-2 py-1 ">
                        Support <AiFillHeart className={"text-lg"}/>
                    </button>
